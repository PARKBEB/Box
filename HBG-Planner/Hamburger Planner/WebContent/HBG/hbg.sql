...
create table hbg_user (
	...
	user_activation_key varchar2(255) default '0' not null,
	user_status varchar2(1) default '0' not null,
...
create table hbg_board_memo (
	...
	CONSTRAINT hbg_fk_board_memo FOREIGN KEY (board_no) REFERENCES hbg_board(board_no),
...
create table hbg_board_clist (
	...
	CONSTRAINT hbg_fk_board_clist FOREIGN KEY (board_no) REFERENCES hbg_board(board_no),
	CONSTRAINT hbg_pk_board_clist PRIMARY KEY (board_no)
);

create table hbg_board_cldar (
	board_no number not null,
	CONSTRAINT hbg_fk_board_cldar FOREIGN KEY (board_no) REFERENCES hbg_board(board_no),
...
create table hbg_service (
	...
	CONSTRAINT hbg_fk_serv_user FOREIGN KEY (user_no) REFERENCES hbg_user(user_no),
