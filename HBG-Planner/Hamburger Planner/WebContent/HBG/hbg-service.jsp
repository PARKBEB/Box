            ...
            <div id="hbg-service">
                ...
                <div class="content-1">
                    <div class="content-1s content-1-1 thm-board">
                        <div class="title thm-color thm-border">사용 가능한 보드</div>
                        <div class="scroll">
                            ...
                            <li>
                                <div class="content-1-1-1">
                                    ...
                                    <div class="content-1-1-1-2">
                                        ...
                                        <div class="content-1-1-1-1-2 thm-subcolor">당신의 생각을 자유롭게 적어보세요.</div>
                                    </div>
                                </div>
                            ...
                            <li>
                                <div class="content-1-1-1">
                                    ...
                                    <div class="content-1-1-1-2">
                                        ...
                                        <div class="content-1-1-1-1-2 thm-subcolor">설명</div>
                                    </div>
                                </div>
                    ...
                    <div class="content-1s content-1-2 thm-board">
                        <div class="title thm-color thm-border">사용중인 보드</div>
                    ...
                    <div class="content-1s content-1-3 thm-board">
                        <div class="title thm-color thm-border">보드 관리</div>
                        
                        <div>
                        	<ul>
                                <li onclick="boardPlusBtn()">보드 추가<div class="folder-plus"></div></li>
                                <li onclick="boardMinusBtn()">보드 삭제<div class="folder-minus"></div></li>
                                <li onclick="boardShareBtn()">보드 공유<div class="folder-share"></div></li>
                                <script>
...
$(document).ready(function () {
	...
	function htmlSLIP(BOARD_NO, BOARD_TITLE, BOARD_TYPE, BOARD_UPDATE) {
		return '<li class="demo-no-swipe ' + BOARD_NO + '" data-board-no="' + BOARD_NO + '"><div class="content-1-2-1"><div class="content-1-1-1-1 ' + BOARD_TYPE + '"></div><div class="content-1-1-1-2"><div class="content-1-1-1-1-1 thm-color">' + BOARD_TITLE + '</div><div class="content-1-1-1-1-2 thm-subcolor">최근 수정일 : ' + BOARD_UPDATE + '</div></div></div><div class="content-1-2-2 minus" data-board-no="' + BOARD_NO + '"></div><div class="content-1-2-2 shareicon" data-board-no="' + BOARD_NO + '"></div></li>';
	}
			...
			success : function(data) {
				...
				$.ajax({
					...
					success : function(data) {
						...
						var SLIP = '<li class="demo-no-swipe ' + BOARDNO + '" data-board-no="' + BOARDNO + '"><div class="content-1-2-1"><div class="content-1-1-1-1 ' + BOARDTYPE + '"></div><div class="content-1-1-1-2"><div class="content-1-1-1-1-1 thm-color">' + BOARDTITLE + '</div><div class="content-1-1-1-1-2 thm-subcolor">최근 수정일 : ' + BOARDUPDATE + '</div></div></div><div class="content-1-2-2 minus" data-board-no="' + BOARDNO + '"></div></li>';
...
<div class="text-alarm">저장되었습니다.</div>
...
function openShare(board_no) {
	...
	appendHtml += '공유<a class="share-close" onclick="closeShare()"></a>';
	appendHtml += '</div>';
	appendHtml += '<div class="share-content">';
	appendHtml += '<input type="text" placeholder="공유하고 싶은 사용자의 이메일을 적어주세요.">';
	appendHtml += '<input type="button" value="공유" onclick="shareOK(' + board_no + ')">';
	appendHtml += '</div>';
	appendHtml += '</div>';
...
function toggleAlarm() {
	...
	if (toggle_alarm) {
		var appendHtml = '';
	 	...
	 	appendHtml += 		'<div class="alarm-text">OO님이 보드를 공유하였습니다.</div>';
	 	appendHtml += 		'<input type="button" value="확인" class="alarm-btn" onclick="alarmClose()">';
	 	appendHtml += 	'</div>';
	 	/* 반복문 끝 */
	 	appendHtml += '</div>';		        	
