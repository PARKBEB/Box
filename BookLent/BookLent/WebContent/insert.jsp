...
<body>
	...
	<form name = "frm" method="post" action = "/insert_pro.jsp">
		<table>
		 <tr>
		 	<th>회원번호(자동생성)</th>
		 	<td><input type = "text" style = "font-size:40px;" name ="userno" value = "<%= row + 1%>" readonly></td>
		 </tr>  
		 <tr>
		 	<th>회원성명</th>
		 	<td><input type = "text" style = "font-size:30px;" name ="name" value = ""></td>
		 </tr>    
		 <tr>
		 	<th>고객전화</th>
		 	<td><input type = "text" style = "font-size:25px;" name ="phone1" value = "" size = "6">-
		 		<input type = "text" style = "font-size:25px;" name ="phone2" value = "" size = "6">-
		 		<input type = "text" style = "font-size:25px;" name ="phone3" value = "" size = "6">
		 	</td>
		 </tr>
		 <tr>
		 	<th>회원성별</th>
		 	<td><input type = "radio" style="width:25px;height:25px;border:1px;" name ="gender" value = "M" >남자
		 		<input type = "radio" style="width:25px;height:25px;border:1px;" name ="gender" value = "F">여자
		 	</td>
		 </tr>   
		 <tr>
		 	<th>생년월일</th>
		 	<td><input type = "text" style = "font-size:30px;" name ="birthday" value = ""></td>
		 </tr>   
		 <tr>
		 	<th>가입일자</th>
		 	<td><input type = "text" style = "font-size:35px;" name ="regdate" value = "<%=today %>"></td>
		 </tr>      
		 <tr>
