            ...
            <div id="hbg-register">
                <div class="register-inner">
                    <form name="frm" method="post" enctype="multipart/form-data" action="/hbg?command=RegisterInsert.do">
                        <div class="title co-white">회원가입</div>
                        ...
                        <input class="user_name" name="user_name" type="text" placeholder="이름" autocomplete="off">                      
                        <div class="msg msg-1"></div>
                        <input class="user_email" id=user_email name="user_email" type="text"  placeholder="아이디 (이메일)" autocomplete="off">                        
                        ...
                        <input type="button" class="next" value="확 인">
